...
int main() {
    ...
    string wildcard = "a*c?b";
    string pattern = "acdcb";

    if (solution.match(wildcard, pattern))
        cout << "Wildcard pattern matches the string.\n";
    else
        cout << "Wildcard pattern does not match the string.\n";
